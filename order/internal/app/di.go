...
import (
	api "Jopa/order/internal/api/order/v1"
	cl "Jopa/order/internal/client/grpc"
	invCl "Jopa/order/internal/client/grpc/inventory/v1"
	payCl "Jopa/order/internal/client/grpc/payment/v1"
	kafkaConverter "Jopa/order/internal/converter/kafka"
	"Jopa/order/internal/converter/kafka/decoder"
	"Jopa/order/internal/migrator"
	repo "Jopa/order/internal/repository/order"
	"Jopa/platform/pkg/closer"
	"Jopa/platform/pkg/logger"
	"context"
	"fmt"

	orderConsumer "Jopa/order/internal/service/consumer/order_consumer"
	...
	orderScv "Jopa/order/internal/service/order"
	orderProducer "Jopa/order/internal/service/producer/order_producer"
