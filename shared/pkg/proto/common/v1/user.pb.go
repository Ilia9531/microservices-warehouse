...
// NotificationMethod используется в Register и GetUser
type NotificationMethod struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProviderName  string                 `protobuf:"bytes,1,opt,name=provider_name,json=providerName,proto3" json:"provider_name,omitempty"` // telegram, email, push
	Target        string                 `protobuf:"bytes,2,opt,name=target,proto3" json:"target,omitempty"`                                 // email, chat_id и т.д.
...
const file_common_v1_user_proto_rawDesc = "" +
	...
	"\x06target\x18\x02 \x01(\tR\x06target\"\x98\x01\n" +
	"\x04User\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x14\n" +
	"\x05login\x18\x02 \x01(\tR\x05login\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12P\n" +
	"\x14notification_methods\x18\x04 \x03(\v2\x1d.common.v1.NotificationMethodR\x13notificationMethodsBQZOgithub.com/Ilia9531/microservices-warehouse/shared/pkg/proto/common/v1;commonv1b\x06proto3"
